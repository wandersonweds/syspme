      ...
      <div className="border-b-2 border-gray-800 pb-4 mb-6">
        <div className="flex justify-between items-start">
          <div>
            ...
            {oficina?.telefone && <p className="text-sm text-gray-600">Tel: {oficina.telefone}{oficina?.telefone2 ? ` | ${oficina.telefone2}` : ""}</p>}
  ...
  const buildPrintHtml = (tipo: "orcamento" | "recibo") => {
    ...
    return `<!DOCTYPE html><html lang="pt-BR"><head>
      ...
      <div style="border-bottom:2px solid #1f2937;padding-bottom:16px;margin-bottom:20px;display:flex;justify-content:space-between;align-items:flex-start">
        <div style="display:flex;align-items:flex-start;gap:12px">
          ...
          <div>
            ...
            ${oficData?.telefone ? `<p>Tel: ${oficData.telefone}${oficData?.telefone2 ? ` | ${oficData.telefone2}` : ""}</p>` : ""}
      ...
      <div class="section" style="background:#f9fafb;border-radius:8px;padding:12px">
        ...
        ${(osData.veiculoPlaca || osData.veiculoModelo || osData.veiculoAno || osData.veiculoChassis || osData.veiculoFrota) ? `
        <div style="margin-top:10px;padding-top:10px;border-top:1px solid #e5e7eb">
          <h2 style="margin-bottom:6px">Veículo / Maquinário</h2>
          <div class="grid2">
            ...
            ${osData.veiculoChassis ? `<div><span style="color:#6b7280">Chassis:</span> <strong style="font-family:monospace">${osData.veiculoChassis}</strong></div>` : ""}
            ${osData.veiculoFrota ? `<div><span style="color:#6b7280">Frota:</span> <strong>${osData.veiculoFrota}</strong></div>` : ""}
          </div>
        </div>` : ""}
      </div>
      <div class="section">
  ...
  return (
    <AppLayout>
      <div className="p-6 lg:p-8 max-w-4xl mx-auto space-y-6">
        ...
        {(os.veiculoPlaca || os.veiculoModelo || os.veiculoAno || os.veiculoChassis || os.veiculoFrota || os.houveDeslocamento) && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {(os.veiculoPlaca || os.veiculoModelo || os.veiculoAno || os.veiculoChassis || os.veiculoFrota) && (
              <Card className="border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-base font-semibold flex items-center gap-2">
                ...
                <CardContent className="space-y-2 text-sm">
                  ...
                  {os.veiculoChassis && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono font-semibold">{os.veiculoChassis}</span>
                    </div>
                  )}
                  {os.veiculoFrota && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Frota</span>
                      <span className="font-medium">{os.veiculoFrota}</span>
                    </div>
                  )}
                </CardContent>
              </Card>
